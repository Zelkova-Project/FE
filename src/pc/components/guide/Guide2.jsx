        ...
        <div className="guide2-container">
          <div className="guide2-innerContainer">
            <div className="guide2-flexItem">
              <img src="guide/guide2.1.jpg" className={"guide2-1img"}/>
          ...
          <div className="guide2-innerContainer">
            <div className="guide2-flexItem">
              ...
              <img src="guide/guide2.2.png" className={"guide2-2img"}/>
            </div>
          </div>
          <div className="guide2-innerContainer">
          <div className="guide2-flexItem">
            <div className="guide2-innerFlexItem">
              <h2>실내모습</h2>
              <img src="guide/guide2.3.jpg" className={"guide2-3img"}/>
            </div>
          </div>
          </div>
          <div className="guide2-innerContainer">
            <div className="guide2-flexItem">
              <div className="guide2-innerFlexItem">
                <h2>프로그램</h2>
                <img src="guide/guide2.4.png" className={"guide2-2img"}/>
